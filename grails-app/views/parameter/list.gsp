			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="title" title="${message(code: 'parameter.title.label', default: 'Title')}" />
				...
				<g:each in="${parameterInstanceList}" status="i" var="parameterInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${parameterInstance.id}">${fieldValue(bean: parameterInstance, field: "title")}</g:link></td>
